				...
				<div className="col-span-2 text-xl">
					...
					<div className="pb-24">
						<ul className="list-disc pl-12 max-sm:pl-6">
							...
							<li className="">
								<span className={boldTextCss}>Led a team of 12 members</span>{" "}
								during the graduation project, where I managed task assignments
								and deadlines, resulting in the{" "}
								<span className={boldTextCss}>
									successful completion of the project with excellence.
								</span>
							</li>
							<li className="">
								Served as the{" "}
								<span className={boldTextCss}>
									representative for my section of 40 colleagues for three
									years,
								</span>{" "}
								facilitating communication and coordination between professors,
								teaching assistants, and students, ensuring smooth operations
