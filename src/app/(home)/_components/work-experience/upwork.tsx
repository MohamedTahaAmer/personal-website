		...
		<div className="relative overflow-hidden border-b pt-24 shadow-lg">
			<div className="relative z-10 mx-auto grid max-w-7xl grid-cols-3 grid-rows-1 gap-y-8 px-8 max-lg:grid-cols-1 max-sm:p-2 max-sm:pl-4">
				<div className="_title col-span-1 flex h-fit flex-col items-center">
					...
					<div className="text-xl font-bold text-secondary-foreground/80">February 2019 - March 2022</div>
				</div>
					...
					<div className="pb-24">
						...
						<ul className="list-disc pl-12 max-sm:pl-6">
							<li className="">
								...
								demonstrating proficiency in cutting-edge paradigms of user interface rendering such as Server-Side Rendering{" "}
								<span className={boldTextCss}>(SSR),</span> Server-Side Generation <span className={boldTextCss}>(SSG), </span>
								Client-Side Rendering <span className={boldTextCss}>(CSR),</span> Partial Pre-Rendering <span className={boldTextCss}>(PPR),</span> and{" "}
								<span className={boldTextCss}>on-demand revalidation.</span>
							</li>
							<li className="">
								Acquired an in-depth understanding of <span className={boldTextCss}>Next.js caching layers,</span> by caching static content on{" "}
								<span className={boldTextCss}>Vercel CDN </span>
							...
							<li className="">
								Prioritized <span className={boldTextCss}>accessibility best practices</span> by integrating UI frameworks with built-in accessibility
							...
							<li className="">
								Leveraged <span className={boldTextCss}>Tailwind CSS </span> for styling, ensuring <span className={boldTextCss}>mobile responsiveness</span>{" "}
								and enhancing user experience <span className={boldTextCss}>across devices.</span>
							</li>
						</ul>
					</div>
				</div>
