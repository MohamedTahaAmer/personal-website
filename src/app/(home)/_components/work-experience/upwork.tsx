					...
					<div className="pb-24">
						...
						<ul className="list-disc pl-12 max-sm:pl-6">
							<li className="">
								...
								demonstrating proficiency in cutting-edge paradigms of user interface rendering such as Server-Side
								Rendering <span className={boldTextCss}>(SSR),</span> Server-Side Generation{" "}
								<span className={boldTextCss}>(SSG), </span>
								Client-Side Rendering <span className={boldTextCss}>(CSR),</span> Partial Pre-Rendering{" "}
								<span className={boldTextCss}>(PPR),</span> and{" "}
								<span className={boldTextCss}>on-demand revalidation.</span>
							</li>
							<li className="">
								Acquired an in-depth understanding of <span className={boldTextCss}>Next.js caching layers,</span> by
								caching static content on <span className={boldTextCss}>Vercel CDN </span>
								Network then trigger on demand revalidation. This{" "}
							...
							<li className="">
								Prioritized <span className={boldTextCss}>accessibility best practices</span> by integrating UI
								frameworks with built-in accessibility primitives like <span className={boldTextCss}>Radix-UI </span>
							...
							<li className="">
								Leveraged <span className={boldTextCss}>Tailwind CSS </span> for styling, ensuring{" "}
								<span className={boldTextCss}>mobile responsiveness</span> and enhancing user experience{" "}
