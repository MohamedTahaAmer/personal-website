				...
				<div className="col-span-2 text-xl">
					...
					<div className="pb-24">
						...
						<ul className="list-disc pl-12 max-sm:pl-6">
							<li className="">
								Played a pivotal role within a team of five members across two
								concurrent projects, implementing{" "}
								<span className={boldTextCss}>SCRUM</span> methodology through
								<span className={boldTextCss}> JIRA,</span> which led to
							...
							<li className="">
								Executed deployment strategies on{" "}
								<span className={boldTextCss}>AWS,</span> leveraging{" "}
								<span className={boldTextCss}>EC2</span> instances for hosting,{" "}
								<span className={boldTextCss}>S3</span> for storage, and{" "}
								<span className={boldTextCss}>RDS </span> for database
								management, ensuring seamless integration and optimal
								performance.
							</li>
							<li className="">
								Orchestrated{" "}
								<span className={boldTextCss}>deployment workflows</span> across
								three distinct environments{" "}
								<span className={boldTextCss}>
									(development, quality assurance, and production),{" "}
								</span>{" "}
								integral to maintaining a seamless{" "}
							...
							<li className="">
								...
								<span className={boldTextCss}>
									{" "}
									refactoring and optimization of legacy codebases,
								</span>
								employing parallel programming techniques to address performance
								bottlenecks, resulting in a remarkable{" "}
								<span className={boldTextCss}>
									performance boost of over 50%.
								</span>
							</li>
							<li className="">
								<span className={boldTextCss}>Designed</span> robust database
								architectures and executed seamless
								<span className={boldTextCss}> migrations</span> between
								schemas, ensuring data integrity and compatibility with evolving
