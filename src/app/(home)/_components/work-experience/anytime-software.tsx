			...
			<div className="relative z-10 mx-auto grid max-w-7xl grid-cols-3 grid-rows-1 gap-y-8 px-8 max-lg:grid-cols-1 max-sm:p-2 max-sm:pl-4">
					...
					<a href="https://www.linkedin.com/company/anytime-software">
						<div className="relative mb-2 aspect-square w-24 overflow-hidden rounded-full">
							<Image
								...
								src="/companies/anytime-software.jpeg"
							/>
						</div>
					</a>
				...
				<div className="col-span-2 text-xl">
					...
					<div className="">
						...
						Markiting, cold emails automation.
					</div>
					<div className="">
					...
					<div className="pb-24">
						...
						<ul className="list-disc pl-12 max-sm:pl-6">
							<li className="">
								Collaborated on building large-scale backend applications using{" "}
								<span className={boldTextCss}>Nest.JS</span> along with <span className={boldTextCss}>Next.JS </span>{" "}
								for the client-side.
							</li>
							<li className="">
								Utilized <span className={boldTextCss}>CRON jobs </span> extensively for automated{" "}
								<span className={boldTextCss}>data scraping </span> with
								<span className={boldTextCss}> Selenium </span> and email automation through{" "}
								<span className={boldTextCss}> SMTP </span>
								for sending emails and
								<span className={boldTextCss}> IMAP </span>
								for receiving emails.
							</li>
							<li className="">
								Executed complex client-side state management using <span className={boldTextCss}>Redux Toolkit, </span>{" "}
								handling data fetching, displaying user notifications, and state updates to ensure a pleasant user
								experience.
							</li>
							<li className="">
								Created interactive user experience with <span className={boldTextCss}>React Flow, </span> allowing
								users to tailor their custom functionalities using modular, Lego-like blocks.
							</li>
							<li className="">
								Conducted meticulous <span className={boldTextCss}>end-to-end testing </span> with{" "}
								<span className={boldTextCss}>Playwright </span> and <span className={boldTextCss}>Jest </span>
								for <span className={boldTextCss}>unit testing, </span> detecting errors and bugs in early development
								stages to ensure robustness with code changes.
							</li>
						</ul>
					</div>
				</div>
